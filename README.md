...
- Firstly, check your motor currents. Ensure that your `run_current` for your A/B/X/Y motors are correct. 
    ...
    - To find the *maximum* `run_current`:
        ...
        - We are derating the motors/drivers for margin of safety. Rated currents are the absolute maximum *in ideal conditions*. In reality, things like chamber temp come into play. It's also standard practice to keep a margin of safety.
...
- Pass variables to `PRINT_START` (allows the most control, but is more complex)
    - See the *"Passing Variables to PRINT_START"* section [here](https://github.com/AndrewEllis93/Ellis-PIF-Profile#passing-variables-to-print_start).
