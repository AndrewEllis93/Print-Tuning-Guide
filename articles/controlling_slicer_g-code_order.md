---
layout: default
title: Controlling Temperature G-Code Order (Simple Method)
#nav_order: 4
parent: Miscellaneous
---
# Controlling Temperature G-Code Order (Simple Method)

**The method shown in the [:page_facing_up: "Passing Slicer Variables to PRINT_START"](http://localhost:4000/Print-Tuning-Guide/articles/passing_slicer_variables.html) instructions is generally the preferable way to set it up**, as it allows you the most control, but it is more complex.
