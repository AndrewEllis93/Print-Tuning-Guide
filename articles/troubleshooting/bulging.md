...
First of all, you should tune your [:page_facing_up: pressure advance](http://localhost:4000/Print-Tuning-Guide/articles/pressure_advance.html) and [:page_facing_up: extrusion multiplier](http://localhost:4000/Print-Tuning-Guide/articles/extrusion_multiplier.html) using this guide's methods.

After that, see [:page_facing_up: Small Infill Areas Look Overextruded](http://localhost:4000/Print-Tuning-Guide/articles/troubleshooting/small_infill_areas_overextruded.html).\
...
- If these do not fix it, it might instead be an [:page_facing_up: overheating issue.](http://localhost:4000/Print-Tuning-Guide/articles/cooling_and_layer_times.html).