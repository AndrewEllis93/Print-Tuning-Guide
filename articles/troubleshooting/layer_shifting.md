...
### Electrical
- #### Motor Currents
    - Check your motor currents. Ensure that the `run_current` configured for your A/B/X/Y motors are correct. See [:page_facing_up:"Determining Motor Currents"](/articles/determining_motor_currents.md).
- #### Wiring
